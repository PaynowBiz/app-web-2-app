...
## 4. 시작하기
 ...
 3) [Construct.java](https://github.com/PaynowBiz/app-web-2-app/blob/main/src/main/java/com/tosspayments/paynowbiz/util/Construct.java#L10) 에서 연동 하고자 하는 `url` 로 설정값을 변경해서 호출 하면 됩니다.
<br>
